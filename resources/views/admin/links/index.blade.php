...
<!--面包屑导航 开始-->
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> / 全部友情链接
    </div>
    <!--面包屑导航 结束-->
                    ...
                    @foreach($data as $v)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript: void(0); " class="del" target-id="{{$v->id}}">删除</a>
                            </td>
                        </tr>
                    @endforeach
    ...
    <script type="text/javascript" charset="utf-8" async defer>
        $(function (){
            ...
            $('.field_order').on('change', function (){
                ...
                $.post('{{url("admin/links/changesort")}}', {
