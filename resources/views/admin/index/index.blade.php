...
@section('content')
	...
	<div class="top_box">
		<div class="top_left">
			<div class="logo">Welcome, {{ session('uname') }}</div>
			<ul>
				<li><a href="{{url('/')}}" class="active" target="_blank">网站首页</a></li>
				<li><a href="{{url('admin/index')}}">后台首页</a></li>
			</ul>
		</div>
		<div class="top_right">
			<ul>
				<li>管理员：{{ session('uname') }}</li>
	...
	<div class="menu_box">
		<ul>
            ...
            <li>
                ...
                <ul class="sub_menu" style="display: block;">
					<li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-cubes"></i>友链管理</a></li>
	...
	<!--底部 开始-->
	<div class="bottom_box">CopyRight © 2017</div>
	<!--底部 结束-->
